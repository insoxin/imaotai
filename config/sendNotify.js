/*
 * @Author: insoxin https://github.com/insoxin/imaotai/
 * @Last Modified by: insoxin
 * @Last Modified time: 2022-4-3 15:00:54
 * sendNotify 推送通知功能
 * @param text 通知头
 * @param desp 通知体
 * @param params 某些推送通知方式点击弹窗可跳转, 例：{ url: 'https://abc.com' }
 * @param author 作者仓库等信息  例：`本通知 By：https://github.com/insoxin/imaotai/`
 */
...
async function sendNotify(
  ...
  desp,
  params = {},
  author = '\n\n本通知 By：https://github.com/insoxin/imaotai/',
) {
  //提供6种通知
          ...
          case '0':
            options = {
              ...
              textcard: {
                title: `${text}`,
                description: `${desp}`,
                url: 'https://github.com/insoxin/imaotai/',
                btntxt: '更多',
              },
            };
            break;
